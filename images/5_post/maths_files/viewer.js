...
var DEFAULT_URL = 'mba-logo-quiz.pdf';
//var DEFAULT_URL = 'current_affairs_april_2016_ebook.pdf';
 ...
 * @property {HTMLButtonElement} notetextButton - The button used to show
 *   the comments view.
...
var PDFSidebar = (function PDFSidebarClosure() {
  ...
  function PDFSidebar(options) {
	...
	this.notetextButton = options.notetextButton;
	
    this.thumbnailView = options.thumbnailView;
    this.outlineView = options.outlineView;
    this.attachmentsView = options.attachmentsView;
	this.notetextView = options.notetextView;
  ...
  PDFSidebar.prototype = {
    reset: function PDFSidebar_reset() {
      ...
      //this.notetextButton.disabled = false;
    },
	...
	//get isNotetextViewVisible() {
      //return (this.isOpen && this.active === SidebarView.NOTETEXT);
    //},
    ...
    switchView: function PDFSidebar_switchView(view, forceOpen) {
      ...
      switch (view) {
        case SidebarView.THUMBS:
		  ...
		  this.notetextButton.classList.remove('toggled');
          this.attachmentsButton.classList.remove('toggled');          

          this.thumbnailView.classList.remove('hidden');
          this.outlineView.classList.add('hidden');
		  this.notetextView.classList.add('hidden');
        ...
        case SidebarView.ATTACHMENTS:
          ...
          break;
		case SidebarView.NOTETEXT:
          if (this.notetextButton.disabled) {
            return;
          }
          this.thumbnailButton.classList.remove('toggled');
          this.outlineButton.classList.remove('toggled');
		  this.notetextButton.classList.add('toggled');
          this.attachmentsView.classList.remove('toggled');          

          this.thumbnailView.classList.add('hidden');
          this.outlineView.classList.add('hidden');
		  this.notetextView.classList.remove('hidden');
          this.attachmentsView.classList.add('hidden');          
          break;
        default:
    ...
    _addEventListeners: function PDFSidebar_addEventListeners() {
	  ...
	  self.notetextButton.addEventListener('click', function() {
        self.switchView(SidebarView.NOTETEXT);
      });
...
function getViewerConfiguration() {
  return {
    ...
    sidebar: {
	  ...
	  notetextButton: document.getElementById('viewNotetext'),
      // Views
      thumbnailView: document.getElementById('thumbnailView'),
      outlineView: document.getElementById('outlineView'),
      attachmentsView: document.getElementById('attachmentsView'),
	  notetextView: document.getElementById('noteView')
    },
    findBar: {
