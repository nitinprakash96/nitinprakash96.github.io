...
/* package thenitinprakash-0.1.0.0 */
#ifndef VERSION_thenitinprakash
#define VERSION_thenitinprakash "0.1.0.0"
#endif /* VERSION_thenitinprakash */
#ifndef MIN_VERSION_thenitinprakash
#define MIN_VERSION_thenitinprakash(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_thenitinprakash */
...
#define CURRENT_COMPONENT_ID "thenitinprakash-0.1.0.0-DFnZokHtgUVLk4Ljuill2T-site"
